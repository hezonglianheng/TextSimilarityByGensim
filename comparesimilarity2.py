...
file_name1 = r'lda_similarity.txt'
file1 = open(file_name1, encoding='utf8', mode='w+')
model, dictionary1, corpus1, corpus_titles1 = corpora2model.create_lda()
index1 = similarities.MatrixSimilarity(model[corpus1])
vectors1 = [dictionary1.doc2bow(doc) for doc in documents]
lsis = [model[vec] for vec in vectors1]
sims1 = [index1[v] for v in lsis]
